		...
		$(function() {
			...
			$("#save_record")
					.click(
							function() {
								...
								var guest_score = $("#record_guest_score")
										.val();
								if (!reg.test(host_score)
										|| !reg.test(guest_score)) {
									ds.dialog({
										title : '消息提示',
								...
								var host_foul = $("#host_foul_input").val();
								var host_offside = $("#host_offside_input").val();
								var host_overtime_score = $("#host_offside_input").val();
								...
								var guest_foul = $("#guest_foul_input").val();
								var guest_offside = $("#guest_offside_input").val();
								var guest_overtime_score = $("#guest_offside_input").val();
			...
			//添加记录条数
			$("#host_foul_table img[src*='add_jilu.png']")
					.click(
							function() {
			...
			$("#guest_foul_table  img[src*='add_jilu.png']")
					.click(
							function() {
								var st = $(this).parent().parent();
								$(st)
			...
			$("#host_goal_table  img[src*='add_jilu.png']")
					.click(
							function() {
								var st = $(this).parent().parent();
								$(st)
			...
			$("#guest_goal_table  img[src*='add_jilu.png']")
					.click(
							function() {
								var st = $(this).parent().parent();
								$(st)
			...
			$("#league_search_select")
					.change(
							function() {
								var league_id = $("#league_search_select")
								...
								$
										.ajax({
											...
											success : function(data) {
												...
												$("#zone_search_select")
														.append(
																"<option id='search_zone_option_0'>全部</option>");
												$
														.each(
																data.zones,
																function(i,
																	...
																	$(
																			"#zone_search_select")
																			.append(
																					"<option id='search_zone_option_" + item.zoneId + "'>"
																							+ item.zoneName
																							+ "</option>");
																});
											},
			...
			$("#game_league_select")
					.change(
							function() {
								...
								var league_id = $("#game_league_select").find(
			...
			$("#addmatch_btn")
					.click(
							function() {
								...
								var zone_id = $("#game_zone_select").find(
										'option:selected').attr("id")
										.substr(17);
								var group_index = $("#game_group_select").find(
										'option:selected').val();
								var game_order = 1; //小组赛
								if (group_index == 5) {
									game_order = 2; //淘汰赛
								}
								var host_team_id = $("#host_team_select").find(
										"option:selected").attr("id")
										.substr(19);
							...
							$('.record')
									.click(
											function() {
												$("#host_goal_bottom_tr")
														.siblings().remove();
												$("#guest_goal_bottom_tr")
														.siblings().remove();
												$("#host_foul_bottom_tr")
														.siblings().remove();
												$("#guest_foul_bottom_tr")
														.siblings().remove();
												var game_id = $(this).parent()
														.parent().attr("id")
														.substr(7);
												...
												$
														.ajax({
															...
															success : function(
																	data) {
																$(
																		"#record_host_school_name")
																		.html(
																				data.game.hostSchoolName);
																$(
																		"#record_guest_school_name")
																		.html(
																				data.game.guestSchoolName);
																...
																if (guestTeamName == null
																	...
																	guestTeamName = "球队未命名";
																$(
																		"#record_host_team_name")
																		.html(
																				hostTeamName);
																$(
																		"#record_guest_team_name")
																		.html(
																				guestTeamName);
						...
						success : function(data) {
							$(".refresh_select")
									.each(
											function() {
												if ($(this).get(0).selectedIndex != 0) {
													selectedId = $(this).find(
															"option:selected")
															.attr("id");
													selectedSchoolName = $(this)
															.find(
																	"option:selected")
															.text();
													$(this).empty();
													...
													if (obj != null)
														$(this)
																.append(
																		"<option id='" + selectedId + "' selected='selected'>"
																				+ selectedSchoolName
																				+ "</option>");
												} else {
													$(this).empty();
												...
												$
														.each(
																...
																function(i,
																	...
																	$(theObj)
																			.append(
																					"<option id='team_select_option_" + item.teamId + "'>"
																							+ item.schoolName
																							+ "</option>");
																});
											});
