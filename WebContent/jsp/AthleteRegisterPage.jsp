		...
		$("#button_register")
				.click(
						function() {
							...
							$.ajax({
								type : 'POST',
								url : "${pageContext.request.contextPath}/athletemanagement/addathlete.html",
								data : {
									name : name,
									gender : gender,
									nation : nation,
			...
			<table class="center_table" border="0" cellpadding="0"
					...
					<td><div class="input_wk">
							...
							<div class="input_m">
								<input id="name_input" type="text" class="input_text"
									name="nameL" readonly="readonly">
							</div>
							<div class="input_r"></div>
						</div></td>
					<td rowspan=5 width="175px">&nbsp;</td>
					<td rowspan=5 width="325px"><object id="CardReader1"
					...
					<td><div class="input_wk">
							...
							<div class="input_m">
								<input id="nation_input" type="text" class="input_text"
									name="nationL" readonly="readonly">
							</div>
							<div class="input_r"></div>
						</div></td>
				</tr>
				<tr>
					...
					<td><div class="input_wk">
							<div class="input_l"></div>
							<div class="input_m">
								<input id="birthday_input" readonly="readonly" type="text"
