	...
	$(function() {
		...
		$("#register_op_btn").click(function(){
			$("#athlete_frame").attr("src", 
					"${pageContext.request.contextPath}/athletemanagement/adminregisterathlete.html");
		});
...
<body>
	...
	<iframe id="athlete_frame" class="main_content" frameborder="0"
		src="${pageContext.request.contextPath}/athletemanagement/adminregisterathlete.html">
	</iframe>
</body>
</html>