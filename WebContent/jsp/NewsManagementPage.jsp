...
<script language="javascript" type="text/javascript">
	$(function() {
		$("#news_list_btn").click(function(){
			$("#news_frame").attr("src", 
					"${pageContext.request.contextPath}/newsmanagement/newslist.html");
		});
		$("#news_edit_btn").click(function(){
			$("#news_frame").attr("src", "${pageContext.request.contextPath}/newsmanagement/editnews.html");
		});
		$("#vote_result_btn").click(function(){
			$("#news_frame").attr("src", "${pageContext.request.contextPath}/newsmanagement/votelist.html");
		});
	});
</script>
<title>新闻管理</title>
...
<body>
		...
		<ul class="a_news">
			<li id="news_list_btn" class="border_bo"><div>
					<img src="images/a_revise.png" />
				</div>
				<p>新闻列表</p></li>
			<li id="news_edit_btn"><div>
					<img src="images/a_signup.png" />
				</div>
				<p>添加新闻</p></li>
	...
	<iframe id="news_frame" class="main_content" frameborder="0"
		src="${pageContext.request.contextPath}/newsmanagement/newslist.html">
	</iframe>
</body>
</html>
