...
public class WechatResourceUtil {
	...
	public static String getAccess_token(){  
		...
		String APPID = AccountFinalUtil.appId1; //wxfba0f532107c8ffe
		String APPSECRET = AccountFinalUtil.appSecret1; //70d15dba9074a7b0ce780baa7c361c9f
	...
	public static String createMenu() {
		String menu = "{\"button\":[{\"type\":\"click\",\"name\":\"校足资讯\",\"key\":\"10_NEWS\"}" + 
				...
				",{\"type\":\"click\",\"name\":\"最新赛况\",\"key\":\"23_RESULT\"}" + 
	...
	public static String getMaterialCount() {
		String menu = "{\"type\":image,\"offset\":0,\"count\":1}";
		//此处改为自己想要的结构体，替换即可
		String access_token= getAccess_token();
		...
		try {
			...
			is.read(jsonBytes);
			String message=new String(jsonBytes,"UTF-8");
			return "getMaterialCount返回信息:"+message;
		} catch (MalformedURLException e) {
			e.printStackTrace();
		} catch (IOException e) {
			e.printStackTrace();
	...
	public static YsmsWechataccount getWechatUserInfo(String openId){
		...
		try {
			...
			account.setGroupid(Integer.parseInt(groupid));
...
//		WechatArticleView wav = new WechatArticleView();
//		wav.setAuthor("me");
//		wav.setContent("<html><head><title>hello</title></head><body>123</body></html>");
//		wav.setContent_source_url("www.baidu.com");
//		wav.setDigest("123");
//		wav.setShow_cover_pic("0");
//		wav.setThumb_media_id("smtN4YgwILNFTwqMkuMTXc4PaNExVtm4gHVbIpj8AAU");
//		wav.setTitie("nihao");
//		List<WechatArticleView> list = new ArrayList<WechatArticleView>();
//		list.add(wav);
//		System.out.println(broadcastMsg(list));
