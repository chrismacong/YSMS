...
public class Interceptor extends HandlerInterceptorAdapter implements InitializingBean{  
	...
	public boolean preHandle(HttpServletRequest request,  HttpServletResponse response, Object handler){  
		...
		try {
			...
			else if("unbind".equals(methodNameResolver.getHandlerMethodName(request))&&(url.contains("wechat"))){
				return true;
			}
			else if("modifyinfo".equals(methodNameResolver.getHandlerMethodName(request))&&(url.contains("wechat"))){
				return true;
			}
			else if("news".equals(methodNameResolver.getHandlerMethodName(request))&&(url.contains("newsmanagement"))){
				return true;
			}
			else if("vote".equals(methodNameResolver.getHandlerMethodName(request))&&(url.contains("newsmanagement"))){
				return true;
			}
